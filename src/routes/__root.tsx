...
function NotFoundComponent() {
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-background px-4 pb-20">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "apple-touch-icon", sizes: "180x180", href: "/aegisiqcx-icon-192.png" },
    ],
  }),
...
function RootComponent() {
  ...
  // Global error reporting: unhandled errors + promise rejections are tagged
  // with the current user/tenant and streamed to the telemetry sink.
